      ...
      <Flex h={"75vh"} px={20} borderRadius={20} >
        <Flex flexDirection={"row"}>
          <Flex flexDirection={"column"} justifyContent={"center"} w={"60%"}>
            <Stack spacing={4}>
              <Heading fontSize={"xl"}>HederaWhisper</Heading>
              <Heading fontSize={"6xl"}>
                Send tokens along with a private secret message onchain to your friends by wrapping it in a gift.
              </Heading>
              <Text fontSize={"xl"}>
              ...
              <Link href={"/wrapgift"}>
                <Button w={"80%"}>Wrap a special gift</Button>
              </Link>
            </Stack>
          </Flex>
        ...
        <Flex flexDirection={"column"} justifyContent={"center"} alignItems={"center"}>
          <Stack spacing={4}>
            ...
            <FeatureCard
              ...
              description={"Write a secret msg to go along with your token transfer. A nicer way to send a message along with the gift to your friends and family."}
            />
            <FeatureCard
              step={"05"}
